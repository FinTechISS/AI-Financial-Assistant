...
categories = {
    'Stocks': ['GOOGL - Alphabet', 'AAPL - Apple', 'MSFT - Microsoft', 'AMZN - Amazon', 'FB - Facebook', 'TSLA - Tesla', 'NFLX - Netflix', 'NVDA - Nvidia', 'BABA - Alibaba', 'IBM - IBM'],
    'Options': ['GOOGL - Alphabet', 'AAPL - Apple', 'MSFT - Microsoft', 'AMZN - Amazon', 'FB - Facebook', 'TSLA - Tesla', 'NFLX - Netflix', 'NVDA - Nvidia', 'BABA - Alibaba', 'IBM - IBM'],
